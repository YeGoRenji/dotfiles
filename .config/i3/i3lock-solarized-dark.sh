...
i3lock \
  ...
  --time-font="JetBrains Mono Nerd Font Mono" \
  --date-font="JetBrains Mono Nerd Font Mono" \
  --layout-font="JetBrains Mono Nerd Font Mono" \
  --verif-font="JetBrains Mono Nerd Font Mono" \
  --wrong-font="JetBrains Mono Nerd Font Mono" \
  --radius=120 \
  --ring-width=20 \
  --pass-media-keys \
  --pass-screen-keys \
